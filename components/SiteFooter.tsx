      ...
      <div className="relative section-padding min-h-20 md:h-24 py-3 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 text-[var(--tea-cream)]">
        ...
        <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
          <Link
            ...
            target="_blank"
            rel="noreferrer"
            className="text-xs md:text-sm uppercase tracking-[0.14em] border border-[var(--tea-cream)]/55 px-3 py-2 hover:bg-[var(--tea-cream)] hover:text-[var(--tea-green)] transition-colors"
          >
            {instagramLabel}
          </Link>
          ...
          <Link
            ...
            className="text-xs md:text-sm border border-[var(--tea-cream)]/35 px-3 py-2 hover:bg-[var(--tea-cream)] hover:text-[var(--tea-green)] transition-colors"
          >
